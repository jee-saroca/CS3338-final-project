...
\begin{table}[ht]
    ...
    \hline
     ...
     \hline
     	Jesse Saroca &  12/11/25 &. Update for snapshot 2 & 1.2 \\
	\hline
      	Taiten McKiver & 12/11/25 & Update for final snapshot & 1.3 \\
...
\begin{itemize}
	...
	\item depth\_estimator.tflite - ML model that can guess distances from objects in frame
	\item object\_detector.tflite - ML model that can detect objects in frame
\end{itemize}
